...
public class Ut {
	...
	private double spaceshipProjectileTravelRate;
	...
	public void initVars() {
		...
		spaceshipProjectileTravelRate = 0.03;
	...
	public void updateProjectilePostion() {
		...
		double travelIncrement = spaceshipProjectileTravelRate * axisLength;
		Iterator<Projectile> itr = spceshipProjectiles.iterator();
		while(itr.hasNext()) {
			Projectile p = itr.next();
...
//					oScore.setValue(score);
	...
	public double getProjectileTravelRate() {
		return spaceshipProjectileTravelRate;
	}
	...
	public void setProjectileTravelRate(double projectileTravelRate) {
		this.spaceshipProjectileTravelRate = projectileTravelRate;
	}
	...
	public void setProjectiles(List<Projectile> projectiles) {
		this.spceshipProjectiles = projectiles;
	}
